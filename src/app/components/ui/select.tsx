...
type OptionWithLabel = OptionBase & {
  label: string; // label is required when showSearch is true
};

type OptionWithoutLabel = OptionBase & {
  label?: never; // label is not allowed when showSearch is false
};

// Parent type that determines the structure of options based on showSearch
type TypeOption<ShowSearch extends boolean> = {
  showSearch: ShowSearch;
} & (ShowSearch extends true ? OptionWithLabel : OptionWithoutLabel);
